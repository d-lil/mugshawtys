...
function Card() {
    ...
    var swipe = function (dir) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(canSwipe && currentIndex < db.length)) return [3 /*break*/, 2];
    ...
    return (react_1.default.createElement("div", { className: 'cardDiv' },
        react_1.default.createElement("link", { href: 'https://fonts.googleapis.com/css?family=Damion&display=swap', rel: 'stylesheet' }),
        react_1.default.createElement("link", { href: 'https://fonts.googleapis.com/css?family=Alatsi&display=swap', rel: 'stylesheet' }),
        react_1.default.createElement("div", { className: 'cardContainer' }, db.map(function (character, index) { return (react_1.default.createElement(react_tinder_card_1.default, { ref: childRefs[index], className: 'swipe', key: character.username, onSwipe: function (dir) { return swiped(dir, character.username, index); }, onCardLeftScreen: function () { return outOfFrame(character.username, index); } },
            react_1.default.createElement("div", { style: { backgroundImage: 'url(' + character.image + ')' }, className: 'card' },
                react_1.default.createElement("h3", { className: "cardName" },
                    react_1.default.createElement("b", null, character.username),
                    " - ",
                    character.age,
                    "  ")))); })),
        react_1.default.createElement("div", { className: 'buttons' },
            react_1.default.createElement("button", { style: { backgroundColor: !canSwipe && '#c3c4d3' }, onClick: function () { return swipe('left'); } }, "\u2716"),
            react_1.default.createElement("button", { style: { backgroundColor: !canGoBack && '#c3c4d3' }, onClick: function () { return goBack(); } }, "\u21AA"),
            react_1.default.createElement("button", { style: { backgroundColor: !canSwipe && '#c3c4d3' }, onClick: function () { return swipe('right'); } }, "\uD83D\uDDA4")),
        lastDirection ? (react_1.default.createElement("h6", { key: lastDirection, className: 'infoText' },
            "You swiped ",
            lastDirection)) : (react_1.default.createElement("h6", { className: 'infoText' }, "You can only undo once you have swiped!"))));
}
