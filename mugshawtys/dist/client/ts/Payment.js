...
function TransactionStatus() {
    ...
    return (React.createElement("div", null, myTransactions.map(function (tx, index) {
        ...
        return (React.createElement("div", { key: index },
            ...
            React.createElement("p", null,
                "Status: ",
                tx.receipt ? 'Mined' : 'Pending'),
            React.createElement("p", null,
                "Block number: ", (_a = tx.receipt) === null || _a === void 0 ? void 0 :
                _a.blockNumber)));
    })));
}
...
function App() {
    ...
    return (React.createElement("div", null,
        ...
        etherBalance && (React.createElement("div", { className: "balance" },
            React.createElement("br", null),
            "Address:",
            React.createElement("p", { className: "bold" }, account),
            React.createElement("br", null),
            "Balance:",
            React.createElement("p", { className: "bold" }, (0, units_1.formatEther)(etherBalance)))),
        React.createElement(SendTransaction, null),
        React.createElement(TransactionStatus, null)));
}
// Render the App component inside the DAppProvider
ReactDOM.render(React.createElement(core_1.DAppProvider, { config: config },
